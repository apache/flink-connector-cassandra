 ...
 * org.apache.flink.streaming.runtime.operators.WriteAheadSinkTestBase} from Flink's repo.
 *
 * <p>During Flink's JUnit 5 migration, WriteAheadSinkTestBase became package-private in
 * flink-streaming-java, breaking external connectors that extended it for testing. (FLINK-25544)
 *
 * <p>This copy allows the Cassandra connector to continue testing write-ahead sink functionality
