...
public final class CollectionFieldMappers {
    ...
    public static final class ArrayMapper implements CassandraFieldMapper {
        ...
        public Object extractRowFieldValue(Row row, String fieldName) {
            ...
            return convertValueToFlinkType(rawValue);
        }
        ...
        public Object convertValueToFlinkType(Object value) {
            ...
            if (!(value instanceof List)) {
                throw new ValidationException("Expected List, got: " + value.getClass());
            }

            List<?> list = (List<?>) value;
            Object[] array = new Object[list.size()];
            for (int i = 0; i < list.size(); i++) {
                array[i] = fieldMapper.convertValueToFlinkType(list.get(i));
            }
    ...
    public static final class MapMapper implements CassandraFieldMapper {
        ...
        public Object convertValueToFlinkType(Object value) {
            ...
            if (!(value instanceof Map)) {
                throw new ValidationException("Expected Map, got: " + value.getClass());
            }

            Map<?, ?> map = (Map<?, ?>) value;
            Map<Object, Object> resultMap = new HashMap<>();
            for (Map.Entry<?, ?> entry : map.entrySet()) {
                Object convertedKey = keyConverter.convertValueToFlinkType(entry.getKey());
                Object convertedValue = valueConverter.convertValueToFlinkType(entry.getValue());
    ...
    public static final class SetMapper implements CassandraFieldMapper {
        ...
        public Object convertValueToFlinkType(Object value) {
            ...
            if (!(value instanceof Set)) {
                throw new ValidationException("Expected Set, got: " + value.getClass());
            }

            Set<?> set = (Set<?>) value;
            Map<Object, Object> resultMap = new HashMap<>();
            for (Object element : set) {
                Object convertedElement = fieldMapper.convertValueToFlinkType(element);
            ...
            if (value instanceof UDTValue) {
                ...
                for (int i = 0; i < fieldCount; i++) {
                    ...
                    if (!udtValue.isNull(nestedFieldName)) {
                        ...
                        fieldValue = fieldMappers[i].convertValueToFlinkType(rawValue);
                    }
