...
public interface CassandraFieldMapper extends Serializable {
     ...
     */
    @Nullable
    Object extractRowFieldValue(Row row, String fieldName);

    /**
     * Convert a raw value to Flink internal format.
     *
     * <p>This method is used when we already have a raw value that needs to be converted to Flink's
     * internal format. Common scenarios include:
     *
     * <ul>
     ...
     */
    @Nullable
    default Object convertValueToFlinkType(Object value) {
        return value;
    }
}
