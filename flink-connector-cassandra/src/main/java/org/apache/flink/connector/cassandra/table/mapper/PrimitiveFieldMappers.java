...
public final class PrimitiveFieldMappers {
    ...
    public static final class BooleanMapper implements CassandraFieldMapper {
        @Override
        public Object extractRowFieldValue(Row row, String fieldName) {
    ...
    public static final class IntegerMapper implements CassandraFieldMapper {
        ...
        @Override
        public Object convertValueToFlinkType(Object value) {
            if (value == null) {
                return null;
            }
    ...
    public static final class StringMapper implements CassandraFieldMapper {
        ...
        public Object extractRowFieldValue(Row row, String fieldName) {
            ...
            switch (columnType) {
                ...
                default:
                    return convertValueToFlinkType(row.getString(fieldName));
            }
        }
    ...
    public static final class DecimalMapper implements CassandraFieldMapper {
        ...
        public Object extractRowFieldValue(Row row, String fieldName) {
            ...
            return convertValueToFlinkType(row.getDecimal(fieldName));
        }
    ...
    public static final class DateMapper implements CassandraFieldMapper {
        ...
        public Object extractRowFieldValue(Row row, String fieldName) {
            ...
            return convertValueToFlinkType(row.getDate(fieldName));
        }
    ...
    public static final class TimeMapper implements CassandraFieldMapper {
        ...
        public Object extractRowFieldValue(Row row, String fieldName) {
            ...
            return convertValueToFlinkType(row.getTime(fieldName));
        }
    ...
    public static final class TimestampMapper implements CassandraFieldMapper {
        ...
        public Object extractRowFieldValue(Row row, String fieldName) {
            ...
            return convertValueToFlinkType(row.getTimestamp(fieldName));
        }
    ...
    public static final class BinaryMapper implements CassandraFieldMapper {
        ...
        public Object extractRowFieldValue(Row row, String fieldName) {
            ...
            return convertValueToFlinkType(row.getBytes(fieldName));
        }
    ...
    public static final class VarintMapper implements CassandraFieldMapper {
        ...
        public Object extractRowFieldValue(Row row, String fieldName) {
            ...
            return convertValueToFlinkType(row.getVarint(fieldName));
        }
    ...
    public static final class DynamicDecimalMapper implements CassandraFieldMapper {
        ...
        public Object extractRowFieldValue(Row row, String fieldName) {
            ...
            switch (cassandraType.toLowerCase()) {
                case "varint":
                    return varintMapper.extractRowFieldValue(row, fieldName);
                case "decimal":
                default:
                    return decimalMapper.extractRowFieldValue(row, fieldName);
            }
        }
        ...
        public Object convertValueToFlinkType(Object value) {
            if (value instanceof BigInteger) {
                return varintMapper.convertValueToFlinkType(value);
            } else {
                return decimalMapper.convertValueToFlinkType(value);
            }
        }
    }
}
